...
public class UserService {
	...
	public String RegisterUser(@FormParam("Name") String username, @FormParam("Email") String email,
	...
	@Consumes(MediaType.APPLICATION_FORM_URLENCODED)
	@Produces(MediaType.TEXT_PLAIN)
	public String updateUser(@FormParam("Id") String uID, @FormParam("Name") String uName,
			@FormParam("Email") String uEmail, @FormParam("Password") String uPass) {
		System.out.println("Api called");
