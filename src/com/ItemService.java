...
Item itemObj = new Item();
	...
	{ 
	  System.out.println("--------------------");
		String output = itemObj.insertItem(itemCode, itemName, itemPrice, itemDesc,quantity); 
		return  output; 
	}
	...
	//Read the values from the JSON object
	 ...
	 String output = itemObj.updateItem(itemID, itemCode, itemName, itemPrice, itemDesc,quantity); 
	 return output; 
	}
	...
	//Read the value from the element <itemID>
	 String itemID = ((Element) doc).select("itemID").text(); 
